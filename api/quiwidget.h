...
public Q_SLOTS:
    ...
    //弹出输入框
    static QStringList showInputBoxs(bool on, bool &ok, const QStringList  title, const QStringList  data, int num);
...
public Q_SLOTS:
    ...
    void setParameters(bool on, const QStringList  title, QStringList data, int num);
